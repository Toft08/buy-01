...
class AuthControllerIntegrationTest {
    ...
    void testLoginClient() throws Exception {
        ...
        // Then login
        String loginData = "{\"email\":\"loginclient@test.com\",\"password\":\"pass123\"}";
    ...
    void testLoginWrongPassword() throws Exception {
        ...
        String loginData = "{\"email\":\"passtest@test.com\",\"password\":\"wrongpass\"}";
    ...
    void testLoginNonExistentUser() throws Exception {
        String loginData = "{\"email\":\"nonexistent@test.com\",\"password\":\"pass123\"}";
